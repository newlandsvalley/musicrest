...
java -Dconfig.file=conf/musicrest.conf -classpath target/scala-2.10/musicrest-2.10-1.1.4.jar org.bayswater.musicrest.tools.BulkImport $abcdir $dbname $collection
